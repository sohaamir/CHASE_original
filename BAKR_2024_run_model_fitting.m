...
output_dir = fullfile(project_folder, 'results', 'burgi_subset');
...
%% model fitting
% get data
load(fullfile(project_folder,'data','behavioral_data_bot_5.mat'));
...
save(fullfile(output_dir,'supplementary','fits_LK_perblock.mat'),'fits_LK_perblock');